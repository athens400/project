...
<body<?php if ($this->views->hasContent('bodyClass')) : ?> class='<?php $this->views->render('bodyClass')?>'<?php endif; ?>>
<!--<body class='<?=$this->request->getRoutePreg()?>'>-->

<div id="wrapper-outer">

    <?php if ($this->views->hasContent('above-header')) : ?>
    <div id="above-header">
        <?php $this->views->render('above-header')?>
    </div>
    <?php endif; ?>
